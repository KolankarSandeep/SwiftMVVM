...
class SideMenuTableViewController: UITableViewController {
    ...
    @IBAction func logoutAction(_ sender: Any) {
        self.showAlert(Constants.Logout.logbout, message: Constants.Message.logoutWarning, actions: [Constants.Logout.cancel, Constants.Logout.logbout]) { (actionTitle) in
            if actionTitle == Constants.Logout.logbout {
